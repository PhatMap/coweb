  ...
  return (
    <span className={`brand-mark${small ? " is-small" : ""}`}>
      <svg aria-hidden="true" viewBox="0 0 24 24">
        <path d="M10 6H8a6 6 0 0 0 0 12h2 M12 7l2 10 3-7 3 7 2-10" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
    </span>
  );
}
...
function browserTabTitleFromTitle(value: string | undefined, copy: Copy): string {
  ...
  if (!title || title === "about:blank" || title.includes("coweb-browser-host")) return copy.temporaryChat;
