...
const launcherName = process.platform === "win32" ? "coweb.cmd" : "coweb";
const launcher = process.platform === "win32" ? `@echo off
setlocal
chcp 65001 >nul
set "ROOT=%~dp0.."
set "COWEB_CLI_LAUNCHER=%~f0"
...
export COWEB_CLI_LAUNCHER="$invoked"
...
copyFileSync(join(root, "NOTICE.md"), join(output, "NOTICE.md"));
