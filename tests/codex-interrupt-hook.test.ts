...
test("Interrupt hook command is absolute, quoted, and bound to the exact application home", () => {
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["/Applications/CoWeb.app/runtime/bun", "/Applications/CoWeb.app/app/cli.js"] },
    "/Users/test/Application Support/CoWeb",
    "darwin",
  )).toBe(
    "'/Applications/CoWeb.app/runtime/bun' '/Applications/CoWeb.app/app/cli.js'"
      + " '--home' '/Users/test/Application Support/CoWeb' 'hook' 'interrupt'",
  );
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["C:\\Program Files\\CoWeb\\bun.exe", "C:\\Program Files\\CoWeb\\cli.js"] },
    "C:\\Users\\test\\CoWeb",
    "win32",
  )).toBe(
    '"C:\\Program Files\\CoWeb\\bun.exe" "C:\\Program Files\\CoWeb\\cli.js"'
      + ' "--home" "C:\\Users\\test\\CoWeb" "hook" "interrupt"',
  );
});
