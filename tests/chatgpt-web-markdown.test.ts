...
test("turns observed inline file path formats into Markdown links", () => {
  const cases = [
    ...
    {
      path: "/Users/example/coweb/src/path-format-probe/gamma-helper.ts",
      target: "/Users/example/coweb/src/path-format-probe/gamma-helper.ts",
    },
    {
      path: "/Users/example/coweb/output/path-format-probe/epsilon-report.pdf",
      target: "/Users/example/coweb/output/path-format-probe/epsilon-report.pdf",
    },
    {
